odoo.define("rainbow_community_theme.DrawerMenu", function (require) {
    "use strict";
    ...
    class DrawerMenu extends Component {
         ...
         * @param {boolean} props.enableCategory enable apps category
         * @param {Object[]} props.categoryData apps category data
         * @param {Object[]} props.apps application icons
         * @param {string} props.apps[].action
         * @param {number} props.apps[].id
         * @param {number} props.apps[].category_id
         ...
         * @param {number} props.menuItems[].category_id
         */
        constructor() {
            // 构造函数
            super(...arguments);
            ...
            this.enableCategory = this.props.enableCategory;
            this.categoryData = this.props.categoryData;
        ...
        patched() {
            if (this.state.focusedIndex !== null && !this.env.device.isMobile) {
                const selectedItem = document.querySelector('.o_drawer_menu .o_menuitem.o_focused');
         ...
         * elongating the content of the Drawer menu.
         * @private
         */
        ...
        _onKeydown(ev) {
            ...
            switch (ev.key) {
                ...
                case 'Escape':
                    ...
                    // before ESC
                    // Hide Drawer menu if there is an inner action
    ...
    DrawerMenu.template = "DrawerMenu";
